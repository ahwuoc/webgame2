...
<img height="12" src="<?= LOGO_PATH ?>?v=<?= time() ?>" style="vertical-align:middle" />
<span style="vertical-align:middle">Dành cho người chơi trên 12 tuổi. Chơi quá 180 phút mỗi ngày sẽ hại sức khỏe.</span><br /><br/>
                            
         <img src="<?= LOGO_PATH ?>?v=<?= time() ?>" style="max-height: 40px; max-width: 20%" />
...
<span style="vertical-align:middle"><?php echo date('Y'); ?> Được vận hành bởi <?= GAME_NAME ?></span><br /><br/>