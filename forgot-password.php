...
<div class="ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-24">
                        <div class="page-layout-body">
                            <!-- load view -->
                            <div class="ant-row">
    <div class="ant-col ant-col-24 home_page_bodyTitleList__UdhN_">Twitch Respass</div>
    </div>
                ...
                try {
                    ...
                    if ($storedGmail === $gmail) {
                        ...
                        try {
                            ...
                            $mail->SMTPAuth = true;
                            $mail->Username = 'ngocrong@gmail.com'; // Thay đổi thành email của bạn
                            $mail->Password = 'palixbbrkrubxcsu'; // Thay đổi thành mật khẩu của bạn
                            $mail->SMTPSecure = 'tls';
                            $mail->Port = 587;

                            // Thiết lập thông tin email
                            $mail->setFrom('ngocrong@gmail.com', 'Ngọc Rồng Twitch'); // Thay đổi thành email của bạn và tên của bạn
                            $mail->addAddress($gmail);
                            $mail->Subject = '=?UTF-8?B?' . base64_encode('Quên Mật Khẩu - Ngọc Rồng Twitch') . '?=';
