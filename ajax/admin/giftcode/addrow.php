...
<div class="row form_gift" data-row="<?= $code; ?>">
    <div class="col-sm-12 col-md-6">
        <div class="input-group mb-3">
            <select class="select2 form-control custom-select col-12" data-row="<?= $code; ?>" name="option_id[<?= $id ?>][]">
    ...
    <div class="col-sm-12 col-md-6">
        <div class="input-group mb-3">
            <input type="text" class="form-control" data-row="<?= $code; ?>" name="param_option[<?= $id ?>][]"
