...
require_once  $_SERVER['DOCUMENT_ROOT'] . "/ajax/service.php";
    ...
    if($user){
      if($row['slot'] >= 1){
        ...
        if($user['vnd'] >= $row['price']){
            ...
            $CVH->Ex(true, "Mua vật phẩm thành công vui lòng vào hòm thư của game để nhận!");
            ...
            Service::gI()->sendBuyWeb($id, $player['id']);
        } else {
